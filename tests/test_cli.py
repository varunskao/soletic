...
class TestCLI:
    ...
    def test_setup_with_relative_log_path(self, runner: CliRunner, clean_config, monkeypatch):
        with runner.isolated_filesystem() as fs:
            # Create a config file in the isolated filesystem
            config_path = os.path.join(fs, ".soletic_config.json")
    ...
    def test_setup_with_absolute_log_path(self, temp_dir, runner: CliRunner, clean_config, monkeypatch):
        with runner.isolated_filesystem() as fs:
            # Create a config file in the isolated filesystem
            config_path = os.path.join(fs, ".soletic_config.json")
    ...
    def test_setup_with_default_log_location(self, runner: CliRunner, clean_config, monkeypatch):
    ...
    def test_preserve_existing_values(self, runner: CliRunner, temp_config, monkeypatch):
        ...
        with runner.isolated_filesystem() as fs:
            ...
            first_result = runner.invoke(cli, ['update', '--network', 'devnet', '--use-cache', 'False'])
